    ...
    >
      <div className="w-full max-w-4xl flex flex-col h-full">
        <div className="flex-shrink-0 mb-2 md:mb-4">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-center text-black mt-1 md:mt-2">
            PERFECT HAIR CARE
          </h1>
        </div>
        ...
        <div className="flex-grow flex flex-col justify-center gap-2 md:gap-4 relative">
          ...
          <DisplaySection
            ...
            className="absolute bottom-4 left-4 z-10 scale-75 transform origin-bottom-left"
          />
        </div>
        ...
        <div className="flex-shrink-0 mt-2 md:mt-4">
          <Button 
            ...
            className="w-full max-w-xs mx-auto bg-[#ea384c] hover:bg-[#ea384c]/90 text-white rounded-full flex items-center justify-center gap-2 text-lg md:text-xl py-4 md:py-6" 
            size="lg"
          >
