    ...
    >
      <div className="max-w-4xl w-full space-y-8">
        <div className="flex flex-col items-center space-y-4">
          <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2835 777" width="400" height="200" className="mb-6">
            <defs>
