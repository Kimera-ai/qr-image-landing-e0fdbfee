    ...
    >
      <div className="w-full max-w-4xl flex flex-col h-full">
        <div className="flex-shrink-0 mb-0">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-center text-black mt-0.5">
            PERFECT HAIR CARE
          </h1>
        </div>
        ...
        <div className="flex-shrink-0 mt-2 md:mt-4">
          <Button 
            ...
            className="w-full max-w-lg mx-auto bg-[#ea384c] hover:bg-[#ea384c]/90 text-white rounded-full flex items-center justify-center text-3xl md:text-4xl py-8 md:py-10" 
            size="lg"
          >
            סיום
          </Button>
